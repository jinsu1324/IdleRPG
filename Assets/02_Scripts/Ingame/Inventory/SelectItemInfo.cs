...
/// <summary>
/// 선택된 아이템 정보들 표시 및 장착, 해제, 강화버튼 관리
/// </summary>
public class SelectItemInfo : MonoBehaviour
{
    public static event Action OnItemInfoChanged;                       // 아이템 정보가 바뀌었을 때 이벤트
    ...
    /// 초기화
    /// </summary>
    public void Init(ItemSlot selectSlot)
    {
        CurrentItem = selectSlot.CurrentItem;

        Debug.Log($"{CurrentItem.Name} 정보 보여주기!");
